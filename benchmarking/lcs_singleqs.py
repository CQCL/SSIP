...
print("----Zs----")
with Path.open("results/lcs_Z_singleqs.txt", "w") as f:
    f.write("Z merges:\n")
    for l in range(1, 4):
                ...
                if is_irreducible_logical(ind, lcs_code.PX):
                    ...
                    while True:
                        ...
                        if lower1 is None and lower2 is None:
                            ...
                            n_new = num_data_qubits(
                                pushout_data.Code
                            ) - num_data_qubits(lcs_code)
...
print("----Xs----")
with Path.open("results/lcs_X_singleqs.txt", "w") as f:
    f.write("X merges:\n")
    for l in range(1, 4):
        for L in range(l + 2, l + 5):
            if L > 6:
