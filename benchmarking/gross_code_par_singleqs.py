...
print("----Xs----")
with Path.open("results/gross_par_X_singleqs.txt", "w") as f:
    ...
    while True:
        ...
        pushout_data = parallel_single_logical_qubit_measurements(
            bicycle_code, measure_sequence, "X", True
        )
        ...
        if sd >= initial_d:
            ...
            n_new = num_data_qubits(pushout_data.Code) - num_data_qubits(bicycle_code)
...
print("----Zs----")
with Path.open("results/gross_par_Z_singleqs.txt", "w") as f:
    ...
    while True:
        ...
        measure_sequence = MeasureSequence(index_list, depths)
        pushout_data = parallel_single_logical_qubit_measurements(
            bicycle_code, measure_sequence, "Z", True
        )
